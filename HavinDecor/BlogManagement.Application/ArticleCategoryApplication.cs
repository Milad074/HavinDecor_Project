...
namespace BlogManagement.Application
{
    public class ArticleCategoryApplication : IArticleCategoryApplication
    {
        ...
        public OperationResult Create(CreateArticleCategory command)
        {
            ...
            var fileName = _fileUploader.Upload(command.Picture, $"Blog/{command.Slug}");

            var articleCategory = new ArticleCategory(command.Name, fileName, command.PictureAlt , command.PictureTitle,
                command.Description, command.ShowOrder, command.Slug,
        ...
        public OperationResult Edit(EditArticleCategory command)
        {
            ...
            if (_articleCategoryRepository
                .Exists(x => x.Name == command.Name && x.Id != command.Id))
            {
                return operation.Failed(ApplicationMessage.DuplicatedRecord);
            }
        ...
        {
            return _articleCategoryRepository.GerArticleCategories();
        }
